...
public class VVI extends VVT{
	...
	public VVI(double lowerRateLimit, double upperRateLimit,
	...
	public void run() {
		super.run();
		System.out.println("VVT: Funcionalidade não implementada ainda");
	}
